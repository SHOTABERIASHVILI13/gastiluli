...
import "./Hdr.css"
import marketpricelogo from "./marketpricelogo-1.png"  /*changed*/
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div className="container">
        <a  className="navbar-brand" href="/" ><img src={marketpricelogo} className="marketpricelogo" /></a>
      ...
      <footer>marketprice<br/>Tbilisi,Georgia</footer> 
    </nav>
